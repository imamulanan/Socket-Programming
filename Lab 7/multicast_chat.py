...
#  numberofmessages. The chat tool should have the following functionalities:
#  1) Get the messagefromtheuserandsendittoall the other
#  processes belonging to the
#  group. A process can receive a
#  copy of the message.
#  2) Read the messages sent by anyotherprocess and display the
#  message to the user.
